...
const Edit_user = () => {
        ...
        .then(res => {
          console.log(res);
			...
			setUser({
				...
				twitterLink: user.links.twitter?user.links.twitter:"",
				instagramLink: user.links.instagram?user.links.instagram:"",
				siteLink: user.links.site?user.links.site:"",
			});
  ...
  const handleProfile = async e => {
    ...
    if ((profilePhoto || preview) && (coverPhoto || coverPreview) && user.email && user.username && user.bio) {
      ...
      formData.append("twitter", user.twitterLink);
      formData.append("instagram", user.instagramLink);
      formData.append("site", user.siteLink);
      formData.append("address", getItem("userAddress"));
      ...
      axiosInstance
        ...
        .then(res => {
          ...
          if (res.status === 200) {
            ...
            router.push(`/user/${getItem("userAddress")}`)
            setStatus({
              type: "success",
            ...
            <div className="container">
              <div className="mx-auto max-w-[48.125rem] md:flex">
                ...
                <div className="mb-12 md:w-1/2 md:pr-8">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={user.siteLink}
                        onChange={e =>
                          setUser({ ...user, siteLink: e.target.value })}
                      />
                    </div>
                  </div>
                  <div className="mb-6">
                  ...
                  {status.type === "error" &&
                    <p className="py-3 font-semibold text-red transition-all">
                      <span>
                        {status.message}
                      </span>
                    </p>}
                  {status.type === "success" &&
                    <p className="py-3 font-semibold text-green transition-all">
                      <span>
                        {status.message}
                      </span>
                    </p>}
